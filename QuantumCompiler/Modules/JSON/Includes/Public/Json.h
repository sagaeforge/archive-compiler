...
bool          JSON_AppendDeciamlAry   (JSONObject pSelf, const String pFieldName, Object        pValue);
bool          JSON_AppendDigitAry     (JSONObject pSelf, const String pFieldName, Object        pValue);
bool          JSON_AppendBoolAry      (JSONObject pSelf, const String pFieldName, Object        pValue);
bool          JSON_AppendStringAry    (JSONObject pSelf, const String pFieldName, String        pValue);
bool          JSON_AppendObjectAry    (JSONObject pSelf, const String pFieldName, JSONObject    pValue);
bool          JSON_AppendAryAry       (JSONObject pSelf, const String pFieldName, Object        pValue);
...
JSONObject    JSON_Search             (const JSONObject pSelf, const String pFiledName); // 자기 자신을 포함한 모든 곳을 재귀해서 검색
