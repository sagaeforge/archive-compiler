...
ProcessEventModule_Update_Initialized()
{
  ...
  Application.Member.Private_Method.Update_Start = UpdateStart;
  Application.Member.Private_Method.Update_Stop = UpdateStop;
  Application.Member.Private_Method.Update_StopWait = UpdateStopWait;
}