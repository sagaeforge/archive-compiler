...
class Context;
template <typename T>
struct Iterator : public Iteratable<T, Iterator<T>> {
public:
...
public:
    ...
    super_t::position_t operator-(const Iterator &other) const override {
        return m_position - other.position();
    }
    super_t::elem_t operator*() const override {
        return m_context[m_position];
    }
...
public:
    ...
    super_t::position_t position() const override {
        return m_position;
    }
    super_t::elem_t value() const override {
        return m_context[m_position];
    }
