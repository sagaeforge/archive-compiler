...
class IndexExpressionNodeParseStrategy : public parsing::InfixParseStrategy {
  public:
    ...
    virtual parsing::ParseStrategyResult parse(parsing::Parser &parser, const tokenize::TokenStream &tokens, std::shared_ptr<Expression> left) override;
};
