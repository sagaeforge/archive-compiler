...
class ParseStrategy {
  public:
    virtual bool can_parse(const Parser &parser, const tokenize::TokenStream &tokens) = 0;
    virtual ParseStrategyResult parse(Parser &parser, const tokenize::TokenStream &tokens) = 0;
...
class InfixParseStrategy : public ParseStrategy {
  public:
    virtual ParseStrategyResult parse(Parser &parser, const tokenize::TokenStream &tokens, std::shared_ptr<ast::Expression> left) = 0;
};
